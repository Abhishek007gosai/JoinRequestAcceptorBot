...
DB_URI = environ.get("DB_URI", "mongodb+srv://Kafka:Au3OoWzCDYJKeuHU@cluster0.lz2m8iy.mongodb.net/") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
